...
Since the seasonal pattern is strong and stable, I use (0,1,2) as a seasonal difference. The best fit ARIMA model with the lowest AIC is **ARIMA $(2, 0, 1) X (0, 1, 2)_{12}$ **
...
There are a few peaks in this periodogram in frequency 0.27, 0.43 and 0.46. 
...
I can draw a flat line from the smoothed periodogram between the intervals; thus, there is no ambigity. The periodogram demonstrates very stable. 

# ARCH-GARCH Model
Although I used McLeod-Li test to check if there is a need of Arch-garch test, I will to reassure my assumption by running the garch model. 
